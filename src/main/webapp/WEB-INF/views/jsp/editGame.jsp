...
<body>
	...
	<form:form action="${pageContext.request.contextPath}/games/updateGame"
		method="post" modelAttribute="editedGame">
		<form:hidden path="id" />
